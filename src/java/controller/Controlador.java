        ...
        try {
            ...
            switch(botao){
                ...
                case "logar": //evento
                    ...
                    break;
                case "comprar": //evento
                    request.getRequestDispatcher("Comprar").forward(request, response);
                    break;
                case "deletar": //evento
                    request.getRequestDispatcher("Deletar").forward(request, response);
                    break;
                case "finalizar": //evento
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Evento " + botao+ " não processado.</h1>");
            out.println("</body>");
            out.println("</html>");
        } catch (Exception ex) {
            out.println("<!DOCTYPE html>");
